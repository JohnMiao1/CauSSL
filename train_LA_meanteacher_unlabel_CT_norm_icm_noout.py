...
parser.add_argument('--exp', type=str,  default='MT_unlabel_CT_norm_noaug_icm_noout_20230529', help='model_name')
...
if __name__ == "__main__":
    ...
    for name, parameters in model.named_parameters():
        if 'conv' in name and 'weight' in name and 'out' not in name:
